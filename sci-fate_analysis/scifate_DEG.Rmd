...
output_folder <- file.path(base,"202108_output")
...
load(file.path(input_folder, "cds_T_cell_cycle_monocle3.RDS"))
...
df_cell <- readRDS(file.path(input_folder, "df_cell_5k_Tcell_7clust.RDS"))
# individual trajectory df_cell with pseudotime
df_cell_E1 <- readRDS(file.path(input_folder, "df_cell_E1.RDS"))
df_cell_E2 <- readRDS(file.path(input_folder, "df_cell_E2.RDS"))
df_cell_MP <- readRDS(file.path(input_folder, "df_cell_MP.RDS"))
...
saveRDS(cluster_terms_all_clust_all_time, file = file.path(output_folder, 'cluster_terms_all_clust_all_time.Rda'))
saveRDS(cluster_terms_c1a_c5_48h, file = file.path(output_folder, 'cluster_terms_c1a_c5_48h.Rda'))
saveRDS(cluster_terms_c3_c4, file = file.path(output_folder, 'cluster_terms_c3_c4.Rda'))
saveRDS(cluster_terms_c1b_c4, file = file.path(output_folder, 'cluster_terms_c1b_c4.Rda'))
saveRDS(cluster_terms_c1b_c3, file = file.path(output_folder, 'cluster_terms_c1b_c3.Rda'))
...
```{r}
# day 2 clusters
cluster_terms_c1a_c5_48h <- readRDS(file.path(output_folder, 'cluster_terms_c1a_c5_48h.Rda'))

# all timepoints, pairwise comparisons
cluster_terms_c3_c4 <- readRDS(file.path(output_folder, 'cluster_terms_c3_c4.Rda'))
cluster_terms_c1b_c4 <- readRDS(file = file.path(output_folder, 'cluster_terms_c1b_c4.Rda'))
cluster_terms_c1b_c3 <- readRDS(file.path(output_folder, 'cluster_terms_c1b_c3.Rda'))

# all clusters all timepoints
cluster_terms_all_clust_all_time <- readRDS(file.path(output_folder, 'cluster_terms_all_clust_all_time.Rda'))
...
clust_ID <- c('MP(early)', 'MP(late)', 'U', 'E2(early)', 'E2(late)', 'E1(late)', 'E1(early)')
...
write_csv(cluster_terms_all_clust_all_time_towrite, file.path(output_folder, 'supplementary_tables', 'cluster_terms_all_clust_all_time.csv'))

# c1a_c5_48h - MP(early)_E1(early)_48h
cluster_terms_c1a_c5_48h <- readRDS(file.path(output_folder,'cluster_terms_c1a_c5_48h.Rda'))
cluster_terms_c1a_c5_48h_towrite <- add_cluster_label(cluster_terms_c1a_c5_48h, num, clust_ID)
write_csv(cluster_terms_c1a_c5_48h_towrite, file.path(output_folder, 'supplementary_tables', 'cluster_terms_MP(A)_E1(A)_48h.csv'))

# c3_c4 - E2(late)_E1(late)
cluster_terms_c3_c4 <- readRDS(file.path(output_folder, 'cluster_terms_c3_c4.Rda'))
cluster_terms_c3_c4_towrite <- add_cluster_label(cluster_terms_c3_c4, num, clust_ID)
write_csv(cluster_terms_c3_c4_towrite, file.path(output_folder, 'supplementary_tables', 'cluster_terms_E2(B)_E1(B).csv'))

# c1b_c4 - MP(late)_E1(late)
cluster_terms_c1b_c4 <- readRDS(file.path(output_folder, 'cluster_terms_c1b_c4.Rda'))
cluster_terms_c1b_c4_towrite <- add_cluster_label(cluster_terms_c1b_c4, num, clust_ID)
write_csv(cluster_terms_c1b_c4_towrite, file.path(output_folder, 'supplementary_tables', 'cluster_terms_MP(B)_E1(B).csv'))

# c1b_c3 - MP(late)_E2(late)
cluster_terms_c1b_c3 <- readRDS(file.path(output_folder, 'cluster_terms_c1b_c3.Rda'))
cluster_terms_c1b_c3_towrite <- add_cluster_label(cluster_terms_c1b_c3, num, clust_ID)
write_csv(cluster_terms_c1b_c3_towrite, file.path(output_folder, 'supplementary_tables', 'cluster_terms_MP(BP)_E2(B).csv'))  
...
prep_agg_mat <- function(cds_subset, df_cell, cluster_terms, clust_select = NULL,  time_select_startswith = NULL, topn = NULL, GoI = NULL){
  ...
  agg_mat <- aggregate_gene_expression(cds_subset_DE, gene_group_df = NULL, cell_group_df, norm_method = "size_only", scale_agg_values=FALSE)
...
make_volcano <- function(agg_mat, cluster_terms, genes, lit_info_df = NULL, label_color_pair_1 = NULL, label_color_pair_2 = NULL){
...
# Day2, c1a vs c5
volc_c1a_c5_48h = make_volcano(agg_mat_c1a_c5_48h, cluster_terms_c1a_c5_48h, genes, lit_info_df = DEG_immgen_mem_eff_1000, label_color_pair_1 = c("Cluster 1a", "Memory Precursor A", "cyan4"), label_color_pair_2 = c("Cluster 5", "Effector 1A","#ab62c0")) + volc_theme

# all days, c3 vs c4
volc_c3_c4 = make_volcano(agg_mat_c3_c4, cluster_terms_c3_c4, genes, lit_info_df = DEG_immgen_mem_eff_1000, label_color_pair_1 = c("Cluster 3", "E2(B)", "#A50F15"), label_color_pair_2 = c("Cluster 4", "E1(B)","#3F007D")) + volc_theme

# all days, c1b vs c4
volc_c1b_c4 = make_volcano(agg_mat_c1b_c4, cluster_terms_c1b_c4, genes, lit_info_df = DEG_immgen_mem_eff_1000, label_color_pair_1 = c("Cluster 1b", "Memory Precursor B", "#08519C"), label_color_pair_2 = c("Cluster 4", "Effector 1B","#3F007D")) + volc_theme

# all days, c1b vs c3
volc_c1b_c3 = make_volcano(agg_mat_c1b_c3, cluster_terms_c1b_c3, genes, lit_info_df = DEG_immgen_mem_eff_1000, label_color_pair_1 = c("Cluster 1b", "Memory Precursor B", "#08519C"), label_color_pair_2 = c("Cluster 3", "Effector 2B","#A50F15")) + volc_theme

# Save plots
ggsave(volc_c1a_c5_48h, filename = file.path(output_folder, "volc_c1a_c5_48h.pdf"), width=7, height=6)
ggsave(volc_c3_c4, filename = file.path(output_folder, "volc_c3_c4.pdf"), width=7, height=6)
ggsave(volc_c1b_c4, filename = file.path(output_folder, "volc_c1b_c4.pdf"), width=7, height=6)
ggsave(volc_c1b_c3, filename = file.path(output_folder, "volc_c1b_c3.pdf"), width=7, height=6)

```

# Make heatmap of DEGs using complex heatmap
For the heatmap analysis, use agg_mat from all timepoints, all clusters DEG
```{r}
...
pdf(file.path(output_folder, "ht_Tcell_5k_aligned_7clust_400q_GOI-extra_ordered_20221020.pdf"), width=6, height=6) # for paper
draw(ht_list)
dev.off()
...
```{r}
# save
saveRDS(trajectory_terms_compare_to_MP, file = file.path(output_folder, "trajectory_terms_compare_to_MP.Rda"))
...
# Plot pseudotime for each trajectory
```{r}
...
ps_E1_legend <- plot_labels_continuous(df_cell_plot$Tcell_branch_pseudotime_new, df_cell_plot$umap_Tcell_5k_aligned_1, df_cell_plot$umap_Tcell_5k_aligned_2, cell_size=1, with_labels = F) + 
  viridis::scale_color_viridis(option = "inferno",
        name = "Values", na.value = "grey80", end = 0.8, discrete = FALSE, guide = "colourbar")
...
ps_E2 <- plot_labels(df_cell_plot$Tcell_branch_pseudotime_new, df_cell_plot$umap_Tcell_5k_aligned_1, df_cell_plot$umap_Tcell_5k_aligned_2, cell_size=1, with_labels = F) +
  viridis::scale_color_viridis(option = "inferno",
    ...
    theme(legend.title = element_blank(), legend.position = "none")
ps_E2_legend <- plot_labels_continuous(df_cell_plot$Tcell_branch_pseudotime_new, df_cell_plot$umap_Tcell_5k_aligned_1, df_cell_plot$umap_Tcell_5k_aligned_2, cell_size=1, with_labels = F) + 
  viridis::scale_color_viridis(option = "inferno",
        name = "Values", na.value = "grey80", end = 0.8, discrete = FALSE, guide = "colourbar")
...
ps_MP <- plot_labels(df_cell_plot$Tcell_branch_pseudotime_new, df_cell_plot$umap_Tcell_5k_aligned_1, df_cell_plot$umap_Tcell_5k_aligned_2, cell_size=1, with_labels = F) +
  viridis::scale_color_viridis(option = "inferno",
        name = "Values", na.value = "grey80", end = 0.8) +
  theme(legend.title = element_blank(), legend.position = "none") 
ps_MP_legend <- plot_labels_continuous(df_cell_plot$Tcell_branch_pseudotime_new, df_cell_plot$umap_Tcell_5k_aligned_1, df_cell_plot$umap_Tcell_5k_aligned_2, cell_size=1, with_labels = F) + 
  viridis::scale_color_viridis(option = "inferno",
        name = "Values", na.value = "grey80", end = 0.8, discrete = FALSE, guide = "colourbar")
...
save_plot(ps_E1, filename = file.path(output_folder, "ps_E1_0c2a.pdf"), base_height = 3)
save_plot(ps_E2, filename = file.path(output_folder, "ps_E2_0c2a.pdf"), base_height = 3)
save_plot(ps_MP, filename = file.path(output_folder, "ps_MP_0c2a.pdf"), base_height = 3)
save_plot(ps_E1_legend, filename = file.path(output_folder, "ps_E1_0c2a_legend.pdf"), base_height = 3)

```

# Compare between trajectory DEG to TF module genes
```{r}

# load trajectory terms
trajectory_terms <- readRDS(file.path(output_folder, "trajectory_terms_compare_to_MP.Rda"))
...
# which TFs from TF module analysis are in the trajectory DEG?
...
# Run visualiztion of trajectory DEG
```{r}
...
pdf(file.path(output_folder, "DEG_bt_traj_hm.pdf"), width=7, height=8)
...
hm <- out[[1]]
matrix <- out[[2]]
pdf(file.path(output_folder, "DEG_bt_traj_hm_0c2a_top200-GoI_label-all_4clust.pdf"), width=6, height=10)
...
write(clu_df[which(clu_df$Cluster == 'cluster1'), ]$GeneID, file.path(output_folder, "hm_4clust_c1.txt"))
write(clu_df[which(clu_df$Cluster == 'cluster2'), ]$GeneID,file.path(output_folder, "hm_4clust_c2.txt"))
write(clu_df[which(clu_df$Cluster == 'cluster3'), ]$GeneID, file.path(output_folder, "hm_4clust_c3.txt"))
write(clu_df[which(clu_df$Cluster == 'cluster4'), ]$GeneID,file.path(output_folder, "hm_4clust_c4.txt"))

```

# Add gene heatmap cluster label to trajectory term df and save as csv for supplementary table
```{r}
gene_c1_MP <- unique(read.table(file.path(output_folder, "hm_4clust_c1.txt")))
gene_c2_E1_early <- unique(read.table(file.path(output_folder, "hm_4clust_c2.txt")))
gene_c3_E2 <- unique(read.table(file.path(output_folder, "hm_4clust_c3.txt")))
gene_c4_E1_late <- unique(read.table(file.path(output_folder, "hm_4clust_c4.txt")))
...
# save
write_csv(trajectory_terms_top_200_GoI, file.path(output_folder,'supplementary_tables', 'trajectory_terms_200n_GoI.csv'))
```


# Plot expression of gene activity over pseudotime - plot same gene for each branch in given plot

# First, compute TF module expression for each cell and each TF
```{r}
...
# Plot activity of each TF along pseudotime for each branch
```{r}

branch_colors <- c("#3F007D","#A50F15","#08519C") # E1, E2, MP
# ordered
...
g1 <- plot_TF_in_pseudotime_across_branch(df_cell_E1, df_cell_E2, df_cell_MP, TF_module_exprs_new, gene_name_list = c('BHLHE40'), branch_names = c('E1','E2','MP'), branch_colors)
g2 <- plot_TF_in_pseudotime_across_branch(df_cell_E1, df_cell_E2, df_cell_MP, TF_module_exprs_new, gene_name_list = c('TCF7'), branch_names = c('E1','E2','MP'), branch_colors)
g3 <- plot_TF_in_pseudotime_across_branch(df_cell_E1, df_cell_E2, df_cell_MP, TF_module_exprs_new, gene_name_list = c('TBX21'), branch_names = c('E1','E2','MP'), branch_colors)
g4 <- plot_TF_in_pseudotime_across_branch(df_cell_E1, df_cell_E2, df_cell_MP, TF_module_exprs_new, gene_name_list = c('EGR1'), branch_names = c('E1','E2','MP'), branch_colors)
g5 <- plot_TF_in_pseudotime_across_branch(df_cell_E1, df_cell_E2, df_cell_MP, TF_module_exprs_new, gene_name_list = c('STAT3'), branch_names = c('E1','E2','MP'), branch_colors)
g6 <- plot_TF_in_pseudotime_across_branch(df_cell_E1, df_cell_E2, df_cell_MP, TF_module_exprs_new, gene_name_list = c('RUNX2'), branch_names = c('E1','E2','MP'), branch_colors)
g7 <- plot_TF_in_pseudotime_across_branch(df_cell_E1, df_cell_E2, df_cell_MP, TF_module_exprs_new, gene_name_list = c('EOMES'), branch_names = c('E1','E2','MP'), branch_colors)
g8 <- plot_TF_in_pseudotime_across_branch(df_cell_E1, df_cell_E2, df_cell_MP, TF_module_exprs_new, gene_name_list = c('MYB'), branch_names = c('E1','E2','MP'), branch_colors)

# save
save_plot(g1, filename = file.path(output_folder, "pseudotime_gene_plots/activity_BHLHE40_0c2a.pdf"), base_height = 3)
save_plot(g2, filename = file.path(output_folder, "pseudotime_gene_plots/activity_TCF7_0c2a.pdf"), base_height = 3)
save_plot(g3, filename = file.path(output_folder, "pseudotime_gene_plots/activity_TBX21_0c2a.pdf"), base_height = 3)
save_plot(g4, filename = file.path(output_folder, "pseudotime_gene_plots/activity_EGR1_0c2a.pdf"), base_height = 3)
save_plot(g5, filename = file.path(output_folder, "pseudotime_gene_plots/activity_STAT3_0c2a.pdf"), base_height = 3)
save_plot(g6, filename = file.path(output_folder, "pseudotime_gene_plots/activity_RUNX2_0c2a.pdf"), base_height = 3)
save_plot(g7, filename = file.path(output_folder, "pseudotime_gene_plots/activity_EOMES_0c2a.pdf"), base_height = 3)
save_plot(g8, filename = file.path(output_folder, "pseudotime_gene_plots/activity_MYB_0c2a.pdf"), base_height = 3)
